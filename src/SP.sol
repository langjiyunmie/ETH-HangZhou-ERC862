...
contract SP is IERC826 {
    ...
    function mint(address receiver, uint256 id, uint256 amount, uint256 _lockTime) external returns (bool) {
        _mint(receiver, id, amount, _lockTime);
        return true;
    }

    function _mint(address receiver, uint256 id, uint256 amount, uint256 _lockTime) internal {
        balanceOf[receiver][id] += amount;
